 ...
 *
 */
public class DigitalBankingServlet extends ServletContainer {
	private static final Logger LOGGER = Logger.getLogger(DigitalBankingServlet.class);

	private static final long serialVersionUID = 1L;
       
    public DigitalBankingServlet() {
        super();
    }
        
    public DigitalBankingServlet(ResourceConfig resourceConfig) {
	...
	public Value<Integer> service(URI baseUri, URI requestUri,
		...
		System.out.println("In DigitalBankingServlet");
